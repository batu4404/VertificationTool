...
(declare-fun f_x2_0 () Real)
(declare-fun fp_x2_0 () Real)
...
(assert (= f_x2_0 (+ (+ (- x_1 (/ (* (* x_1 x_1) x_1) 6)) (/ (* (* (* (* x_1 x_1) x_1) x_1) x_1) 120)) (/ (* (* (* (* (* (* x_1 x_1) x_1) x_1) x_1) x_1) x_1) 5040))))
(assert (= fp_x2_0 (+ (+ (- 1 (/ (* x_1 x_1) 2)) (/ (* (* (* x_1 x_1) x_1) x_1) 24)) (/ (* (* (* (* (* x_1 x_1) x_1) x_1) x_1) x_1) 720))))
(assert (= x_2 (- x_1 (/ f_x2_0 fp_x2_0))))
(assert (= return x_2))
(assert (not (= return 0)))
(check-sat)
(get-model)